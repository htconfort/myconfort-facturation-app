...
export const ConditionsGenerales: React.FC = () => {
  return (
    <div id="conditions-generales" className="conditions-generales page-break-before">
      ...
      <div className="conditions-content" style={{ fontSize: '9px', lineHeight: '1.3', columns: '2', columnGap: '15px' }}>
        <div className="condition-section" style={{ marginBottom: '8px', breakInside: 'avoid' }}>
          <h3 style={{ color: '#477A0C', fontSize: '10px', marginBottom: '3px', fontWeight: 'bold' }}>Art. 1 - Livraison</h3>
        ...
        <div className="condition-section" style={{ marginBottom: '8px', breakInside: 'avoid' }}>
          <h3 style={{ color: '#477A0C', fontSize: '10px', marginBottom: '3px', fontWeight: 'bold' }}>Art. 2 - Délais de Livraison</h3>
        ...
        <div className="condition-section" style={{ marginBottom: '8px', breakInside: 'avoid' }}>
          <h3 style={{ color: '#477A0C', fontSize: '10px', marginBottom: '3px', fontWeight: 'bold' }}>Art. 3 - Risques de Transport</h3>
        ...
        <div className="condition-section" style={{ marginBottom: '8px', breakInside: 'avoid' }}>
          <h3 style={{ color: '#477A0C', fontSize: '10px', marginBottom: '3px', fontWeight: 'bold' }}>Art. 4 - Acceptation des Conditions</h3>
        ...
        <div className="condition-section" style={{ marginBottom: '8px', breakInside: 'avoid' }}>
          <h3 style={{ color: '#477A0C', fontSize: '10px', marginBottom: '3px', fontWeight: 'bold' }}>Art. 5 - Réclamations</h3>
        ...
        <div className="condition-section" style={{ marginBottom: '8px', breakInside: 'avoid' }}>
          <h3 style={{ color: '#477A0C', fontSize: '10px', marginBottom: '3px', fontWeight: 'bold' }}>Art. 6 - Retours</h3>
        ...
        <div className="condition-section" style={{ marginBottom: '8px', breakInside: 'avoid' }}>
          <h3 style={{ color: '#477A0C', fontSize: '10px', marginBottom: '3px', fontWeight: 'bold' }}>Art. 7 - Tailles des Matelas</h3>
        ...
        <div className="condition-section" style={{ marginBottom: '8px', breakInside: 'avoid' }}>
          <h3 style={{ color: '#477A0C', fontSize: '10px', marginBottom: '3px', fontWeight: 'bold' }}>Art. 8 - Odeur des Matériaux</h3>
        ...
        <div className="condition-section" style={{ marginBottom: '8px', breakInside: 'avoid' }}>
          <h3 style={{ color: '#477A0C', fontSize: '10px', marginBottom: '3px', fontWeight: 'bold' }}>Art. 9 - Règlements et Remises</h3>
        ...
        <div className="condition-section" style={{ marginBottom: '8px', breakInside: 'avoid' }}>
          <h3 style={{ color: '#477A0C', fontSize: '10px', marginBottom: '3px', fontWeight: 'bold' }}>Art. 10 - Paiement</h3>
          <p>Les factures sont payables par chèque, virement, carte bancaire ou espèce à réception.</p>
        </div>

        <div className="condition-section" style={{ marginBottom: '8px', breakInside: 'avoid' }}>
          <h3 style={{ color: '#477A0C', fontSize: '10px', marginBottom: '3px', fontWeight: 'bold' }}>Art. 11 - Pénalités de Retard</h3>
        ...
        <div className="condition-section" style={{ marginBottom: '8px', breakInside: 'avoid' }}>
          <h3 style={{ color: '#477A0C', fontSize: '10px', marginBottom: '3px', fontWeight: 'bold' }}>Art. 12 - Exigibilité en Cas de Non-Paiement</h3>
          <p>Le non-paiement d'une échéance rend immédiatement exigible le solde de toutes les échéances à venir.</p>
        </div>

        <div className="condition-section" style={{ marginBottom: '8px', breakInside: 'avoid' }}>
          <h3 style={{ color: '#477A0C', fontSize: '10px', marginBottom: '3px', fontWeight: 'bold' }}>Art. 13 - Livraison Incomplète ou Non-Conforme</h3>
        ...
        <div className="condition-section" style={{ marginBottom: '8px', breakInside: 'avoid' }}>
          <h3 style={{ color: '#477A0C', fontSize: '10px', marginBottom: '3px', fontWeight: 'bold' }}>Art. 14 - Litiges</h3>
        ...
        <div className="condition-section" style={{ marginBottom: '8px', breakInside: 'avoid' }}>
          <h3 style={{ color: '#477A0C', fontSize: '10px', marginBottom: '3px', fontWeight: 'bold' }}>Art. 15 - Horaires de Livraison</h3>
      ...
      <div style={{ textAlign: 'center', marginTop: '15px', fontSize: '8px', fontStyle: 'italic' }}>
